...
class Pie extends React.Component {
  ...
  render() {
    ...
    return (
      <View width={this.props.width} height={this.props.height} style={{ padding: margin }}>
        <Surface width={this.props.width} height={this.props.height}>
          <Group x={x} y={y}>
            {this._renderPie()}
          </Group>
        </Surface>
        <View style={[styles.pie_info_container, { position: 'absolute', top: margin, left: 3 * margin + this.props.pieWidth }]}>

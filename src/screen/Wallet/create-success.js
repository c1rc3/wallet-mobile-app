                ...
                <View style={styles.fixed_bottom}>
                    <LinearGradient colors={['#242d3b00', '#242d3b']} locations={[0, 0.5]}>
                        <View style={styles.fixed_bottom_button_container}>
                            <RoundedButton onPress={() => this.addWallet()} style={[styles.fixed_bottom_button, styles.send_button]} containerStyle={styles.button_container} text={'SEND'} />
                            <RoundedButton onPress={() => this.addWallet()} style={[styles.fixed_bottom_button, styles.receive_button]} containerStyle={styles.button_container} text={'RECEIVE'} />
                        </View>
                    </LinearGradient>
                </View>
            </Container>
